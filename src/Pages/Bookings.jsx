        ...
        <div className='max-w-[500px] h-[900px] mx-auto bg-black/75 text-white'>
          <div className='max-w-[400px] mx-auto py-16'>
            ...
            <form className='w-full flex flex-col py-4'>
              ...
              <input className='p-3 my-2 bg-gray-700 rounded-xl' type='date' placeholder='Check In' name='date' />
              <input className='p-3 my-2 bg-gray-700 rounded-xl' type='date' placeholder='Check Out' name='date' />
              <textarea className='p-3 my-2 bg-gray-700 rounded-xl' cols={20} placeholder='Comments' />
              <button className='p-3 my-2 rounded-xl text-2xl font-bold border-2 hover:bg-pink-600 hover:border-gray-600'>
                Book
                </button> {' '}
                <Link className='flex items-center text-xl justify-center font-bold' to="/Payment">Payment</Link>
            </form>
          </div>
        </div>
      </div>
