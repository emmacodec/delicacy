...
const Navbar = () => {
  ...
  return (
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
      ...
      {/*Side Menu*/ }
      <div className={nav ? 'fixed w-[300px] h-screen top-0 left-0 bg-white z-10 duration-300' : 'fixed w-[300px] h-screen top-[-100%] left-0 bg-white z-10 duration-300'}>
        <AiOutlineClose 
        onClick={()=>setNav(!nav)} 
        size={30} 
        className='absolute right-4 top-4 cursor-pointer' />
        
        <h2 className='text-2xl p-4'>Best <span className='font-bold'>Delicacies</span></h2>
        <nav>
